...
// ============ PANTALLA DE MEDICIÓN ACTIVA – APARECE ENCIMA SIN OCULTAR NADA ============
function enterMeasurementScreen() {
  // No ocultamos nada, solo mostramos la pantalla de medición
...
function exitMeasurementScreen() {
  ...
  // No mostramos nada porque el contenedor principal nunca se ocultó
}
