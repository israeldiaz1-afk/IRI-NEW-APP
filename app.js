...
function getAccelColor(val) {
  // Ya no se usa para colores dinámicos, pero la mantenemos por si acaso
      ...
      datasets: [
        {
          label: 'Acel. Z',
          data: [],
          borderColor: '#64748b',       // Siempre gris
        ...
        },
        {
          label: 'IRI Corr',
          data: [],
          borderColor: '#f59e0b',       // Color base de la línea, pero se sobrescribe por segmentos
